...
* **Терминологическая последовательность:** Каждый термин или сущность, встречающиеся в документации, должны быть
  либо общеизвестными, либо определёнными ранее в том же документе.
    ...
    * *Специфичные для проекта* (требуют определения при первом упоминании): доменные сущности («Транзакция»,
      «Воркспейс»), внутренние аббревиатуры, нестандартные паттерны. Определение — в скобках сразу после термина
      или в отдельном разделе «Глоссарий», если терминов ≥ 5.
    * **Запрещено:** использовать термин в секции 3, если он введён только в секции 7.
...
6. Убедись, что стиль текста соответствует «Простому языку» и везде объясняется «ЗАЧЕМ». Конкретно проверь:
   ...
   * Каждый специфичный термин или сущность определены до или при первом использовании.
   * Аббревиатуры расшифрованы при первом упоминании.
   * Если специфичных терминов ≥ 5 — добавить раздел «Глоссарий» в конец `technical_reference.md`.
...
- [ ] Каждый специфичный термин/сущность определён до или при первом использовании
- [ ] Аббревиатуры расшифрованы при первом упоминании
- [ ] Если специфичных терминов ≥ 5 — добавлен раздел «Глоссарий»
